-- Now that golfable.co is verified in Resend, send the signup notification
-- from a branded address instead of Resend's onboarding@resend.dev sandbox
-- sender.
    ...
    if resend_key is not null then
      perform net.http_post(
        ...
        body := jsonb_build_object(
          'from', 'Golfable <onboarding@golfable.co>',
